...
export default function Setting({ path, src, ReturnComponent, backgroundColor, trackColor, thumbColor,gradientColor,fontColor  }) {
    const [carBackgroundVolume, setCarBackgroundVolume] = useState(localStorage.getItem("carBackgroundVolume") )
    const [musicBackgroundVolume, setMusicBackgroundVolume] = useState(localStorage.getItem("musicBackgroundVolume"))
    ...
    useEffect(() => {
        localStorage.setItem("carBackgroundVolume",carBackgroundVolume)
    },[carBackgroundVolume])

    function handleMusicBackgroundVolumeChange (e) {
        setMusicBackgroundVolume(e.target.value)
    }

    useEffect(() => {
        localStorage.setItem("musicBackgroundVolume",musicBackgroundVolume)
    },[musicBackgroundVolume])

    function handleCarVolumeChange (e) {
        setCarVolume(e.target.value)
    }

    useEffect(() => {
        localStorage.setItem("carVolume",carVolume)
    },[carVolume])

    function handleHitVolumeChange (e) {
        setHitVolume(e.target.value)
    }
    ...
    return (
        <>
            ...
            <div style={{
                ...
                <h1 style={styles.gradientColor}>赛  车  模  式:</h1>
                <div style={styles.spacing}>
                    ...
                    <RangeInput type="range" trackColor={trackColor} thumbColor={thumbColor} onChange={handleCarBackgroundVolumeChange} value={carBackgroundVolume}/>
                </div>
                <div style={styles.spacing}>
                    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="25" height="25" style={{ fill: '#fff' }}>
                    ...
                    <label  style={styles.label}>赛车声音</label>
                    <RangeInput type="range" trackColor={trackColor} thumbColor={thumbColor} onChange={handleCarVolumeChange} value={carVolume}/>
                </div>
            </div>
            ...
            <div style={{
                ...
                <h1 style={styles.gradientColor}>音 游 模 式:</h1>
                <div style={styles.spacing}>
                    <svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="25" height="25" style={{ fill: '#fff' }}>
                        <path d="M875.52 433.152q-7.168-1.024-12.8-10.24t-8.704-33.792q-5.12-39.936-26.112-58.88t-65.024-27.136q-46.08-9.216-81.408-37.376t-58.88-52.736q-22.528-21.504-34.816-15.36t-12.288 22.528l0 44.032 0 96.256q0 57.344-0.512 123.904t-0.512 125.952l0 104.448 0 58.368q1.024 24.576-7.68 54.784t-32.768 56.832-64 45.568-99.328 22.016q-60.416 3.072-109.056-21.504t-75.264-61.952-26.112-81.92 38.4-83.456 81.92-54.272 84.992-16.896 73.216 5.632 47.616 13.312l0-289.792q0-120.832 1.024-272.384 0-29.696 15.36-48.64t40.96-22.016q21.504-3.072 35.328 8.704t28.16 32.768 35.328 47.616 56.832 52.224q30.72 23.552 53.76 33.792t43.008 18.944 39.424 20.992 43.008 39.936q23.552 26.624 28.672 55.296t0.512 52.224-14.848 38.4-17.408 13.824z" ></path>
                    </svg>
                    <label  style={styles.label}>背景音乐</label>
                    <RangeInput type="range" trackColor={trackColor} thumbColor={thumbColor} onChange={handleMusicBackgroundVolumeChange} value={musicBackgroundVolume}/>
                </div>
                ...
                <div style={styles.spacing}>
                    ...
                    <label  style={styles.label}>打击音效</label>
                    <RangeInput type="range" trackColor={trackColor} thumbColor={thumbColor} onChange={handleHitVolumeChange} value={hitVolume}/>
                </div>
            </div>
        </>
    );
